...
public class NewsFragment extends Fragment implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        tv_top.setBackgroundColor(Color.parseColor("#4A4A4A"));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_news_guonei:
                ...
                editor.commit();
                getTopsData(TYPE_GUONEI);
                tv_guonei.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
            ...
            case R.id.tv_news_guoji:
                ...
                editor.commit();
                getTopsData(TYPE_GUOJI);
                tv_guoji.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
            ...
            case R.id.tv_news_yule:
                ...
                editor.commit();
                getTopsData(TYPE_YULE);
                tv_yule.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
            ...
            case R.id.tv_news_tiyu:
                ...
                editor.commit();
                getTopsData(TYPE_TIYU);
                tv_tiyu.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
            ...
            case R.id.tv_news_junshi:
                ...
                editor.commit();
                getTopsData(TYPE_JUNSHI);
                tv_junshi.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
            ...
            case R.id.tv_news_keji:
                ...
                editor.commit();
                getTopsData(TYPE_KEJI);
                tv_keji.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
            ...
            case R.id.tv_news_caijing:
                ...
                editor.commit();
                getTopsData(TYPE_CAIJING);
                tv_caijing.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
            ...
            case R.id.tv_news_shishang:
                ...
                editor.commit();
                getTopsData(TYPE_SHISHANG);
                tv_shishang.setBackgroundColor(Color.parseColor("#4A4A4A"));
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundColor(Color.BLACK);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundColor(Color.BLACK);
