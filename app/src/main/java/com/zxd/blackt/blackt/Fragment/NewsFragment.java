...
public class NewsFragment extends Fragment implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        tv_top.setBackgroundResource(R.color.colorPrimary);
        tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
        tv_guonei.setBackgroundResource(R.color.colorPrimaryDark);
        tv_guoji.setBackgroundResource(R.color.colorPrimaryDark);
        tv_tiyu.setBackgroundResource(R.color.colorPrimaryDark);
        tv_caijing.setBackgroundResource(R.color.colorPrimaryDark);
        tv_shishang.setBackgroundResource(R.color.colorPrimaryDark);
        tv_yule.setBackgroundResource(R.color.colorPrimaryDark);
        tv_junshi.setBackgroundResource(R.color.colorPrimaryDark);
        tv_keji.setBackgroundResource(R.color.colorPrimaryDark);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_news_shehui:
                ...
                editor.commit();
                getTopsData(TYPE_SHEHUI);
                tv_shehui.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_guonei.setTextColor(Color.parseColor("#F0F8FF"));
                tv_guonei.setBackgroundResource(R.color.colorPrimaryDark);
                tv_guoji.setTextColor(Color.parseColor("#F0F8FF"));
                tv_guoji.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_guonei:
                ...
                editor.commit();
                getTopsData(TYPE_GUONEI);
                tv_guonei.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_guoji:
                ...
                editor.commit();
                getTopsData(TYPE_GUOJI);
                tv_guoji.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_yule:
                ...
                editor.commit();
                getTopsData(TYPE_YULE);
                tv_yule.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_tiyu:
                ...
                editor.commit();
                getTopsData(TYPE_TIYU);
                tv_tiyu.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_junshi:
                ...
                editor.commit();
                getTopsData(TYPE_JUNSHI);
                tv_junshi.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_keji:
                ...
                editor.commit();
                getTopsData(TYPE_KEJI);
                tv_keji.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_caijing:
                ...
                editor.commit();
                getTopsData(TYPE_CAIJING);
                tv_caijing.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
            ...
            case R.id.tv_news_shishang:
                ...
                editor.commit();
                getTopsData(TYPE_SHISHANG);
                tv_shishang.setBackgroundResource(R.color.colorPrimary);
                tv_top.setTextColor(Color.parseColor("#F0F8FF"));
                tv_top.setBackgroundResource(R.color.colorPrimaryDark);
                tv_shehui.setTextColor(Color.parseColor("#F0F8FF"));
                tv_shehui.setBackgroundResource(R.color.colorPrimaryDark);
