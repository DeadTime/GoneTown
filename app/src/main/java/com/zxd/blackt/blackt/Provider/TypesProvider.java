...
public class TypesProvider extends ItemViewProvider<Types,RecyclerView.ViewHolder>{
    @NonNull
    @Override
    ...
    @Override
    protected void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @NonNull Types types) {
